            ...
            <div class="media-block">
              <a class="media-left" href="#"
                ><img
                  ...
                  src="https://bootstraptema.ru/snippets/icons/2016/mia/1.png"
              /></a>
              <div class="media-body">
                <div class="mar-btm">
                  ...
                  <p class="text-muted text-sm">
                    <i class="fa fa-mobile fa-lg"></i> - 19-06-2016
                  </p>
                </div>
                <p>
                  Секция с комментариями для сайта с подключенным Bootstrap!!!
                </p>
                <div class="pad-ver">
                  <div class="btn-group">
                ...
                <div>
                  <div class="media-block">
                    ...
                    <div class="media-body">
                      ...
                      <p>
                        Дада. С формой добавления нового комментария!
                      </p>
                      <div class="pad-ver">
                        <div class="btn-group">
                          <a
                            ...
                            href="#"
                            ><i class="fa fa-thumbs-up"></i> Нравится</a
                          >
                          <a
                  ...
                  <div class="media-block">
                    ...
                    <div class="media-body">
                      <div class="mar-btm">
                        ...
                        >
                        <p class="text-muted text-sm">
                          <i class="fa fa-globe fa-lg"></i> - 20-06-2016
                        </p>
                      </div>
            ...
            <div class="media-block pad-all">
              <a class="media-left" href="#"
                ><img
                  class="img-circle img-sm"
                  alt="Профиль пользователя"
                  src="https://bootstraptema.ru/snippets/icons/2016/mia/4.png"
              /></a>
              <div class="media-body">
                <div class="mar-btm">
                  <a
                  ...
                  >
                  <p class="text-muted text-sm">
                    <i class="fa fa-mobile fa-lg"></i> - 20-06-2016
                  </p>
                </div>
                <p>А я добавлю картинку</p>
                <img class="img-responsive thumbnail" alt="Image" />
                <div class="pad-ver">
                  <span class="tag tag-sm"
                    ><i class="fa fa-heart text-danger"></i> 250 Лайков</span
                  >
                  <div class="btn-group">
                    <a class="btn btn-sm btn-default btn-hover-success" href="#"
                      ><i class="fa fa-thumbs-up"></i
                  ...
                  <div class="media-block pad-all">
                    <a class="media-left" href="#"
                      ><img
                        class="img-circle img-sm"
                        alt="Профиль пользователя"
                        src="https://bootstraptema.ru/snippets/icons/2016/mia/5.png"
                    /></a>
                    <div class="media-body">
                      <div class="mar-btm">
                        <a
