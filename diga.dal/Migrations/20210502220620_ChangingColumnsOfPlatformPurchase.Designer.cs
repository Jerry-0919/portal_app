...
namespace diga.dal.Migrations
{
    ...
    [Migration("20210502220620_ChangingColumnsOfPlatformPurchase")]
    partial class ChangingColumnsOfPlatformPurchase
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("diga.bl.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("MangoPayKYCValidationStatus")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("NewMessagesEmailNotification")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("diga.bl.Models.Platform.Contracts.PlatformContract", b =>
                {
                    ...
                    b.Property<double?>("BudgetOfWorks")
                        .HasColumnType("float");
                    ...
                    b.Property<int?>("GeneralTerm")
                        .HasColumnType("int");

                    b.Property<bool>("IsPrepayment")
                        .HasColumnType("bit");

                    b.Property<bool?>("IsPrepaymentMade")
                        .HasColumnType("bit");

                    b.Property<bool?>("IsPrepaymentPaid")
                        .HasColumnType("bit");

                    b.Property<bool?>("IsReservationPaid")
                        .HasColumnType("bit");

                    b.Property<bool?>("IsResevationMade")
                        .HasColumnType("bit");

                    b.Property<int?>("MainEstimateId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PrepaymentInvoiceFile")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PrepaymentInvoiceFileName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<double?>("PrepaymentPercent")
                        .HasColumnType("float");

                    b.Property<double?>("PrepaymentValue")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("diga.bl.Models.Platform.Contracts.PlatformContractPaymentPart", b =>
                {
                    ...
                    b.Property<double?>("PercentOfWork")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("diga.bl.Models.Platform.Estimates.PlatformEstimateVAT", b =>
                {
                    b.Property<int>("PlatformEstimateId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("PlatformEstimateId", "PlatformVATId");

                    b.HasIndex("PlatformVATId");

                    b.ToTable("PlatformEstimateVATs");
                });
            ...
            modelBuilder.Entity("diga.bl.Models.Platform.Information.PlatformCategory", b =>
                {
                    ...
                    b.Property<double?>("ReservationPercent")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("diga.bl.Models.Platform.MangoPay.PlatformMangoPayUserBankAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PlatformMangoPayUserBankAccounts");
                });

            modelBuilder.Entity("diga.bl.Models.Platform.MangoPay.PlatformMangoPayUserKYCDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PlatformMangoPayUserKYCDocuments");
                });

            modelBuilder.Entity("diga.bl.Models.Platform.MeasurementReport.PlatformMeasurementReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PlatformMeasurementReports");
                });

            modelBuilder.Entity("diga.bl.Models.Platform.MeasurementReport.PlatformMeasurementReportPosition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<double?>("QuantityCompleted")
                        .HasColumnType("float");
                    ...
                    b.ToTable("PlatformMeasurementReportPositions");
                });
            ...
            modelBuilder.Entity("diga.bl.Models.Platform.PaidFeatures.PaidFeature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("diga.bl.Models.Platform.PlatformPurchases.PlatformPurchase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<double>("DebitedFromBalance")
                        .HasColumnType("float");

                    b.Property<double>("DebitedFromMoney")
                        .HasColumnType("float");
                    ...
                    b.Property<string>("ExternalIdentificator")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("PaidFeatureId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("diga.bl.Models.Platform.Users.PlatformUserVerification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PlatformUserVerifications");
                });

            modelBuilder.Entity("diga.bl.Models.Platform.Users.PlatformUserVerificationPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("PlatformUserVerificationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PlatformUserVerificationId");

                    b.ToTable("PlatformUserVerificationPhotos");
                });
            ...
            modelBuilder.Entity("diga.bl.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("diga.bl.Models.Platform.Information.PlatformCountry", "ResidenceCountry")
                        .WithMany()
            ...
            modelBuilder.Entity("diga.bl.Models.Platform.Contracts.PlatformContract", b =>
                {
                    ...
                    b.HasOne("diga.bl.Models.Platform.Estimates.PlatformEstimate", "MainEstimate")
                        .WithMany()
                        .HasForeignKey("MainEstimateId");
            ...
            modelBuilder.Entity("diga.bl.Models.Platform.Estimates.PlatformEstimateVAT", b =>
                {
                    b.HasOne("diga.bl.Models.Platform.Estimates.PlatformEstimate", "PlatformEstimate")
                        .WithMany("PlatformEstimateVATs")
                        .HasForeignKey("PlatformEstimateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("diga.bl.Models.Platform.MangoPay.PlatformMangoPayUserBankAccount", b =>
                {
                    b.HasOne("diga.bl.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("PlatformMangoPayUserBankAccounts")
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("diga.bl.Models.Platform.MeasurementReport.PlatformMeasurementReportPosition", b =>
                {
                    b.HasOne("diga.bl.Models.Platform.Estimates.PlatformEstimatePosition", "PlatformEstimatePosition")
                        .WithMany("PlatformMeasurementReportPositions")
                        .HasForeignKey("PositionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("diga.bl.Models.Platform.MeasurementReport.PlatformMeasurementReport", "PlatformMeasurementReport")
                        .WithMany()
                        .HasForeignKey("ReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PlatformEstimatePosition");

                    b.Navigation("PlatformMeasurementReport");
                });
            ...
            modelBuilder.Entity("diga.bl.Models.Platform.PlatformPurchases.PlatformPurchase", b =>
                {
                    b.HasOne("diga.bl.Models.Platform.PlatformPurchases.PlatformPurchase", "ParentPlatformPurchase")
                        .WithMany()
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ParentPlatformPurchase");
                });
            ...
            modelBuilder.Entity("diga.bl.Models.Platform.Users.PlatformUserVerification", b =>
                {
                    b.HasOne("diga.bl.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("PlatformUserVerifications")
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("diga.bl.Models.Platform.Users.PlatformUserVerificationPhoto", b =>
                {
                    b.HasOne("diga.bl.Models.Platform.Users.PlatformUserVerification", "PlatformUserVerification")
                        .WithMany("Photos")
                        .HasForeignKey("PlatformUserVerificationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PlatformUserVerification");
                });
            ...
            modelBuilder.Entity("diga.bl.Models.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("PlatformMangoPayUserBankAccounts");

                    b.Navigation("PlatformUserVerifications");
            ...
            modelBuilder.Entity("diga.bl.Models.Platform.Contracts.PlatformContract", b =>
                {
                    ...
                    b.Navigation("PlatformChatRooms");
            ...
            modelBuilder.Entity("diga.bl.Models.Platform.Estimates.PlatformEstimate", b =>
                {
                    b.Navigation("PlatformEstimateVATs");
            ...
            modelBuilder.Entity("diga.bl.Models.Platform.Estimates.PlatformEstimatePosition", b =>
                {
                    b.Navigation("PlatformMeasurementReportPositions");
                });
